package org.omo.omospringboot.filter;
...
import org.omo.omospringboot.exception.ErrorResponseDto;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (request.getRequestURI().equals("/api/auth/reissue/token") && request.getMethod().equals(HttpMethod.POST.name())) {
                chain.doFilter(request, response);
            }
