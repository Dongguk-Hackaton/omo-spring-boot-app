...
public class JwtTokenProvider {
    ...
    public String generateAccessToken(Long userProfileId) {
        Claims claims = Jwts.claims().setSubject(String.valueOf(userProfileId)); // subject
        Date now = new Date();
    ...
    public Authentication getAuthentication(String accessToken) {
        ...
        Long userProfileId =  Long.valueOf(claims.get("sub").toString());
        User users = userRepository.findByUserProfileId(userProfileId).orElseThrow(() -> new CustomErrorException(ErrorCode.UserNotFoundError));
